...
const Nav = () => {
    return (
        <section className="w-full px-2 py-4 bg-base-light bg-opacity-90 drop-shadow-md text-base-dark dark:bg-accent-night dark:text-base-light dark:bg-opacity-85">
